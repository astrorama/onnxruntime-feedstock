...
| [![Conda Recipe](https://img.shields.io/badge/recipe-onnxruntime--cpp--novec-green.svg)](https://anaconda.org/conda-forge/onnxruntime-cpp-novec) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/onnxruntime-cpp-novec.svg)](https://anaconda.org/conda-forge/onnxruntime-cpp-novec) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/onnxruntime-cpp-novec.svg)](https://anaconda.org/conda-forge/onnxruntime-cpp-novec) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/onnxruntime-cpp-novec.svg)](https://anaconda.org/conda-forge/onnxruntime-cpp-novec) |
...
Once the `conda-forge` channel has been enabled, `onnxruntime, onnxruntime-cpp, onnxruntime-cpp-novec, onnxruntime-novec` can be installed with `conda`:

```
conda install onnxruntime onnxruntime-cpp onnxruntime-cpp-novec onnxruntime-novec
```

or with `mamba`:

```
mamba install onnxruntime onnxruntime-cpp onnxruntime-cpp-novec onnxruntime-novec
```
